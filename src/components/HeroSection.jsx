      ...
      <div className="mx-auto max-w-7xl lg:px-8">
         <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
               <div className="lg:py-24">
                  ...
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    ...
                    <span className="block text-indigo-400">ship web apps</span></h1>
            ...
            <div className="mt-12 -mb-10 sm:-mb-48 lg:m-0 lg:relative">
               ...
               <img className="w-full lg:absolute lg:h-full lg:w-auto lg:max-w-none" src="https://download.logo.wine/logo/React_(web_framework)/React_(web_framework)-Logo.wine.png" />
                </div>
            </div>
         </div>
      </div>
